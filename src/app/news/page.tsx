            ...
            <section className="mb-8 relative">
              <div className="relative overflow-hidden rounded-3xl bg-slate-950 aspect-[3/4] sm:aspect-[21/9.5] border border-slate-200/50 shadow-md group">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Link href={`/news/${featuredStories[currentSlide].id}`} className="absolute inset-0 w-full h-full block z-10 cursor-pointer">
                      <Image
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                      <div className="lg:col-span-4 flex flex-col justify-start gap-6">
                        <div className="space-y-4">
                          ...
                          <Link href="/news/releases" className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#22c55e] hover:text-[#16a34a] transition-colors">
                            View all <ArrowRight className="w-3.5 h-3.5" />
                          </Link>
                        </div>
                        <Link href={`/news/${pressReleases[0].id}`} className="bg-white rounded-3xl border border-slate-200/50 shadow-none overflow-hidden flex flex-col group cursor-pointer hover:shadow-[0_4px_20px_rgba(0,0,0,0.04)] transition-all duration-300">
                      ...
                      <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6 lg:pt-10">
                        {pressReleases.slice(1, 5).map((release, index) => (
                          <Link key={index} href={`/news/${release.id}`} className="bg-white rounded-3xl border border-slate-200/50 shadow-none overflow-hidden flex flex-col justify-between group cursor-pointer hover:shadow-[0_4px_20px_rgba(0,0,0,0.04)] transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                      <div className="lg:col-span-4 flex flex-col justify-start gap-6">
                        <div className="space-y-4">
                          ...
                          <Link href="/news/stories" className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#22c55e] hover:text-[#16a34a] transition-colors">
                            View all <ArrowRight className="w-3.5 h-3.5" />
                          </Link>
                        </div>
                        <Link href={`/news/${ourStories[0].id}`} className="bg-white rounded-3xl border border-slate-200/50 shadow-none overflow-hidden flex flex-col group cursor-pointer hover:shadow-[0_4px_20px_rgba(0,0,0,0.04)] transition-all duration-300">
                          <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100">
                  ...
                  <section>
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                      <div className="lg:col-span-4 flex flex-col justify-start gap-6">
                        ...
                        {insideTrite[0] && (
                          <Link href={`/news/${insideTrite[0].id}`} className="bg-white rounded-3xl border border-slate-200/50 shadow-none overflow-hidden flex flex-col group cursor-pointer hover:shadow-[0_4px_20px_rgba(0,0,0,0.04)] transition-all duration-300">
                            <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100">
